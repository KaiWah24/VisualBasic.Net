...
Public Class frmInventoryFreshProduce
    Private ds As DataSet = New DataSet()
    Private da As SqlDataAdapter
    Private clickedGroupBox As GroupBox
    Private intRowCount As Integer = 0I
    Private Sub frmInventoryFreshProduce_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        If OpenConnection() = True Then
            strSql = "Select * From Product Where product_category = 'Vegetable' And product_status = 'on shelves'"
            ...
            If ds.Tables("Product").Rows.Count > 0 Then
                ...
                For intI As Integer = 0 To intGroupBoxCount - 1
                    ...
                    Dim lblFreshProduceName As New Label()
                    Dim lblFreshProducePrice As New Label()
                    Dim lblFreshProduceQuantity As New Label()
                    Dim grpFreshProduce As New GroupBox()
                    Dim picFreshProduce As New PictureBox()
                    Dim picFreshProduceBarCode As New PictureBox()
                    Dim lblFreshProduceDescription As New Label()
                    Dim imageData As Byte() = Nothing
                    Dim dblPrice As Double

                    Dim writer As New BarcodeWriter
                    writer.Format = BarcodeFormat.CODE_128
                    With grpFreshProduce
                        .Size = New Size(intGroupBoxWidth, intGroupBoxHeight)
                        .Location = New Point(intPosX, intPosY)
                        .BackColor = Color.White
                    End With
                    grpFreshProduce.Tag = intI
                    AddHandler grpFreshProduce.Click, AddressOf grpFreshProduce_Click
                    ...
                    grpFreshProduce.Controls.Add(lblFreshProduceName)
                    grpFreshProduce.Controls.Add(lblFreshProducePrice)
                    grpFreshProduce.Controls.Add(lblFreshProduceQuantity)
                    grpFreshProduce.Controls.Add(picFreshProduce)
                    grpFreshProduce.Controls.Add(picFreshProduceBarCode)
                    grpFreshProduce.Controls.Add(lblFreshProduceDescription)
                    Me.Controls.Add(grpFreshProduce)
    ...
    Private Sub btnFreshProduceCreate_Click(sender As Object, e As EventArgs) Handles btnFreshProduceCreate.Click
        frmInventoryCreate.strCategory = "Vegetable"
        frmInventoryCreate.ShowDialog()
    End Sub

    Private Sub btnFreshProduceEdit_Click(sender As Object, e As EventArgs) Handles btnFreshProduceEdit.Click
    ...
    Private Sub btnFreshProduceRefresh_Click(sender As Object, e As EventArgs) Handles btnFreshProduceRefresh.Click
        ...
        For Each groupBox As GroupBox In groupBoxesToRemove
            ...
            groupBox.Dispose()
        Next
        frmInventoryFreshProduce_Shown(Nothing, Nothing)
    End Sub
    ...
    Private Sub frmInventoryFreshProduce_Load(sender As Object, e As EventArgs) Handles MyBase.Load
