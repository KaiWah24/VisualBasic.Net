...
Public Class editStaff
    ...
    Private Sub getStaffData()
        ...
        MySqlCommand.Parameters.AddWithValue("@staff_id", organization.intSelectedStaff)
        Dim reader As SqlDataReader = MySqlCommand.ExecuteReader()

        reader.Read()
        lblStaffId.Text = organization.intSelectedStaff
    ...
    Private Sub updateData()
        ...
        strSql = "UPDATE Staff SET staff_name = @staff_name, staff_ic = @staff_ic, staff_email = @staff_email, staff_phone_num = @staff_phone_num, staff_gender = @staff_gender,
                  staff_birthday = @staff_birthday, staff_age = @staff_age, staff_relationship = @staff_relationship, staff_address = @staff_address, staff_status = @staff_status, 
                  staff_position = @staff_position, staff_salary = @staff_salary, staff_date_hired = @staff_date_hired, staff_image = @staff_image WHERE staff_id = @staff_id"
