...
Imports System.IO
Imports ZXing
Public Class frmInventoryBeverage
    Private ds As DataSet = New DataSet()
    Private da As SqlDataAdapter
    Friend clickedGroupBox As GroupBox
    Private intRowCount As Integer = 0I
    Private Sub frmInventoryBeverage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If OpenConnection() = True Then
            strSql = "Select * From Product Where product_category = 'Beverage' And product_status = 'on shelves'"
            ...
            If ds.Tables("Product").Rows.Count > 0 Then
                ...
                For intI As Integer = 0 To intGroupBoxCount - 1
                    ...
                    Dim lblBeverageName As New Label()
                    Dim lblBeveragePrice As New Label()
                    Dim lblBeverageQuantity As New Label()
                    Dim lblBeverageDescription As New Label()
                    Dim grpBeverage As New GroupBox()
                    Dim picBeverage As New PictureBox()
                    Dim picBeverageBarCode As New PictureBox()
                    ...
                    End With
                    grpBeverage.Tag = intI
                    AddHandler grpBeverage.Click, AddressOf grpBeverage_Click
                    ...
                    With lblBeverageDescription
                        ...
                        .Visible = False
                    End With
                    grpBeverage.Controls.Add(lblBeverageName)
                    grpBeverage.Controls.Add(lblBeveragePrice)
                    grpBeverage.Controls.Add(lblBeverageQuantity)
                    grpBeverage.Controls.Add(picBeverage)
                    grpBeverage.Controls.Add(picBeverageBarCode)
                    grpBeverage.Controls.Add(lblBeverageDescription)
                    Me.Controls.Add(grpBeverage)
    ...
    Private Sub btnBeverageCreate_Click(sender As Object, e As EventArgs) Handles btnBeverageCreate.Click
        frmInventoryCreate.strCategory = "Beverage"
        frmInventoryCreate.ShowDialog()
    End Sub

    Private Sub btnBeverageRefresh_Click(sender As Object, e As EventArgs) Handles btnBeverageRefresh.Click
        ...
        For Each groupBox As GroupBox In groupBoxesToRemove
            ...
            groupBox.Dispose()
        Next
        frmInventoryBeverage_Load(Nothing, Nothing)
    End Sub

    Private Sub btnBeverageEdit_Click(sender As Object, e As EventArgs) Handles btnBeverageEdit.Click
